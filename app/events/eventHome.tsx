...
type EditField  = "date" | "location" | "description" | null;
...
export function EventHome() {
    ...
    const saveEdit = () =>{
        const updatedEvent = {
            ...curEvent,
            ...(editing === "date" ? {date: draft.date} : {}),
            ...(editing === "location" ? {location: draft.location} : {}),
            ...(editing === "description" ? {description: draft.description} : {}),
        }
        ...
        updateEvent(String(curEvent?.id), {
